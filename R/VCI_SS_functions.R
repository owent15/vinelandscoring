...
ComSSFunc0_1 <- function(vabs_total_age, vci_com_total_vscale_r){
  score <- c()
  if (vabs_total_age >= 0 & vabs_total_age < 1) { 
    if(vci_com_total_vscale_r==2){score <-20}
    else if(vci_com_total_vscale_r==3){score <-23}
    else if(vci_com_total_vscale_r==4){score <-26}
    else if(vci_com_total_vscale_r==5){score <-29}
    else if(vci_com_total_vscale_r==6){score <-32}
    else if(vci_com_total_vscale_r==7){score <-35}
    else if(vci_com_total_vscale_r==8){score <-38}
    else if(vci_com_total_vscale_r==9){score <-40}
    else if(vci_com_total_vscale_r==10){score <-42}
    else if(vci_com_total_vscale_r==11){score <-45}
    else if(vci_com_total_vscale_r==12){score <-48}
    else if(vci_com_total_vscale_r==13){score <-51}
    else if(vci_com_total_vscale_r==14){score <-54}
    else if(vci_com_total_vscale_r==15){score <-57}
    else if(vci_com_total_vscale_r==16){score <-60}
    else if(vci_com_total_vscale_r==17){score <-63}
    else if(vci_com_total_vscale_r==18){score <-66}
    else if(vci_com_total_vscale_r==19){score <-69}
    else if(vci_com_total_vscale_r==20){score <-72}
    else if(vci_com_total_vscale_r==21){score <-75}
    else if(vci_com_total_vscale_r==22){score <-78}
    else if(vci_com_total_vscale_r==23){score <-80}
    else if(vci_com_total_vscale_r==24){score <-83}
    else if(vci_com_total_vscale_r==25){score <-85}
    else if(vci_com_total_vscale_r==26){score <-88}
    else if(vci_com_total_vscale_r==27){score <-91}
    else if(vci_com_total_vscale_r==28){score <-94}
    else if(vci_com_total_vscale_r==29){score <-97}
    else if(vci_com_total_vscale_r==30){score <-100}
    else if(vci_com_total_vscale_r==31){score <-103}
    else if(vci_com_total_vscale_r==32){score <-106}
    else if(vci_com_total_vscale_r==33){score <-109}
    else if(vci_com_total_vscale_r==34){score <-112}
    else if(vci_com_total_vscale_r==35){score <-115}
    else if(vci_com_total_vscale_r==36){score <-118}
    else if(vci_com_total_vscale_r==37){score <-121}
    else if(vci_com_total_vscale_r==38){score <-124}
    else if(vci_com_total_vscale_r==39){score <-127}
    else if(vci_com_total_vscale_r==40){score <-130}
    else if(vci_com_total_vscale_r==41){score <-132}
    else if(vci_com_total_vscale_r==42){score <-135}
    else if(vci_com_total_vscale_r==43){score <-137}
    else if(vci_com_total_vscale_r>=44 & vci_com_total_vscale_r<=48){score <-140}
    else {score <- NA}
  }
  else {score <- NA}
  return(score)
    ...
    ComSSFunc1_2 <- function(vabs_total_age, vci_com_total_vscale_r){
      score <- c()
      if (vabs_total_age >= 1 & vabs_total_age < 2) { 
        if(vci_com_total_vscale_r==2){score <-20}
        else if(vci_com_total_vscale_r==3){score <-25}
        else if(vci_com_total_vscale_r==4){score <-28}
        else if(vci_com_total_vscale_r==5){score <-31}
        else if(vci_com_total_vscale_r==6){score <-34}
        else if(vci_com_total_vscale_r==7){score <-37}
        else if(vci_com_total_vscale_r==8){score <-40}
        else if(vci_com_total_vscale_r==9){score <-43}
        else if(vci_com_total_vscale_r==10){score <-46}
        else if(vci_com_total_vscale_r==11){score <-49}
        else if(vci_com_total_vscale_r==12){score <-51}
        else if(vci_com_total_vscale_r==13){score <-54}
        else if(vci_com_total_vscale_r==14){score <-57}
        else if(vci_com_total_vscale_r==15){score <-60}
        else if(vci_com_total_vscale_r==16){score <-63}
        else if(vci_com_total_vscale_r==17){score <-66}
        else if(vci_com_total_vscale_r==18){score <-68}
        else if(vci_com_total_vscale_r==19){score <-70}
        else if(vci_com_total_vscale_r==20){score <-73}
        else if(vci_com_total_vscale_r==21){score <-76}
        else if(vci_com_total_vscale_r==22){score <-79}
        else if(vci_com_total_vscale_r==23){score <-81}
        else if(vci_com_total_vscale_r==24){score <-83}
        else if(vci_com_total_vscale_r==25){score <-86}
        else if(vci_com_total_vscale_r==26){score <-89}
        else if(vci_com_total_vscale_r==27){score <-91}
        else if(vci_com_total_vscale_r==28){score <-94}
        else if(vci_com_total_vscale_r==29){score <-97}
        else if(vci_com_total_vscale_r==30){score <-100}
        ...
        else if(vci_com_total_vscale_r==34){score <-111}
        else if(vci_com_total_vscale_r==35){score <-114}
        else if(vci_com_total_vscale_r==36){score <-117}
        else if(vci_com_total_vscale_r==37){score <-120}
        else if(vci_com_total_vscale_r==38){score <-122}
        else if(vci_com_total_vscale_r==39){score <-124}
        else if(vci_com_total_vscale_r==40){score <-127}
        else if(vci_com_total_vscale_r==41){score <-129}
        else if(vci_com_total_vscale_r==42){score <-131}
        else if(vci_com_total_vscale_r==43){score <-133}
        else if(vci_com_total_vscale_r==44){score <-135}
        else if(vci_com_total_vscale_r==45){score <-138}
        else if(vci_com_total_vscale_r>=46 & vci_com_total_vscale_r<=48){score <-140}
        else {score <- NA}
      }
      else {score <- NA}
      return(score)
...
ComSSFuncTotal <- function(vabs_total_age, vci_com_total_vscale_r){
  ...
  if(is.na(vabs_total_age) | vci_com_total_vscale_r==0) {score <- NA}
    ...
    score <- ComSSFunc0_1(vabs_total_age, vci_com_total_vscale_r)
  }
  else if (vabs_total_age >= 1 & vabs_total_age <2) {
    score <- ComSSFunc1_2(vabs_total_age, vci_com_total_vscale_r)
  }
...
DlsSSFunc0_1 <- function(vabs_total_age, vci_dls_total_vscale_r){
  score <- c()
  if (vabs_total_age >= 0 & vabs_total_age < 1) { 
    if(vci_dls_total_vscale_r==1){score <-20}
    else if(vci_dls_total_vscale_r==2){score <-28}
    else if(vci_dls_total_vscale_r==3){score <-36}
    else if(vci_dls_total_vscale_r==4){score <-44}
    else if(vci_dls_total_vscale_r==5){score <-51}
    else if(vci_dls_total_vscale_r==6){score <-57}
    else if(vci_dls_total_vscale_r==7){score <-64}
    else if(vci_dls_total_vscale_r==8){score <-70}
    else if(vci_dls_total_vscale_r==9){score <-73}
    else if(vci_dls_total_vscale_r==10){score <-77}
    else if(vci_dls_total_vscale_r==11){score <-80}
    else if(vci_dls_total_vscale_r==12){score <-84}
    else if(vci_dls_total_vscale_r==13){score <-88}
    else if(vci_dls_total_vscale_r==14){score <-94}
    else if(vci_dls_total_vscale_r==15){score <-100}
    else if(vci_dls_total_vscale_r==16){score <-106}
    else if(vci_dls_total_vscale_r==17){score <-111}
    else if(vci_dls_total_vscale_r==18){score <-117}
    else if(vci_dls_total_vscale_r==19){score <-122}
    else if(vci_dls_total_vscale_r==20){score <-127}
    else if(vci_dls_total_vscale_r==21){score <-133}
    else if(vci_dls_total_vscale_r==22){score <-138}
    else if(vci_dls_total_vscale_r>=23 & vci_dls_total_vscale_r<=24){score <-140}
    else {score <- NA}
  }
  else {score <- NA}
  return(score)
...
DlsSSFunc1_2 <- function(vabs_total_age, vci_dls_total_vscale_r){
  score <- c()
  if (vabs_total_age >= 1 & vabs_total_age < 2) { 
    if(vci_dls_total_vscale_r==1){score <-20}
    else if(vci_dls_total_vscale_r==2){score <-24}
    else if(vci_dls_total_vscale_r==3){score <-32}
    else if(vci_dls_total_vscale_r==4){score <-39}
    else if(vci_dls_total_vscale_r==5){score <-47}
    else if(vci_dls_total_vscale_r==6){score <-54}
    else if(vci_dls_total_vscale_r==7){score <-61}
    else if(vci_dls_total_vscale_r==8){score <-67}
    else if(vci_dls_total_vscale_r==9){score <-73}
    else if(vci_dls_total_vscale_r==10){score <-78}
    else if(vci_dls_total_vscale_r==11){score <-82}
    else if(vci_dls_total_vscale_r==12){score <-87}
    else if(vci_dls_total_vscale_r==13){score <-91}
    else if(vci_dls_total_vscale_r==14){score <-96}
    else if(vci_dls_total_vscale_r==15){score <-101}
    else if(vci_dls_total_vscale_r==16){score <-107}
    else if(vci_dls_total_vscale_r==17){score <-113}
    else if(vci_dls_total_vscale_r==18){score <-118}
    else if(vci_dls_total_vscale_r==19){score <-123}
    else if(vci_dls_total_vscale_r==20){score <-127}
    else if(vci_dls_total_vscale_r==21){score <-131}
    else if(vci_dls_total_vscale_r==22){score <-134}
    else if(vci_dls_total_vscale_r==23){score <-137}
...
DlsSSFuncTotal <- function(vabs_total_age, vci_dls_total_vscale_r){
  ...
  if(is.na(vabs_total_age) | vci_dls_total_vscale_r==0) {score <- NA}
    ...
    score <- DlsSSFunc0_1(vabs_total_age, vci_dls_total_vscale_r)
  }
  else if (vabs_total_age >= 1 & vabs_total_age <2) {
    score <- DlsSSFunc1_2(vabs_total_age, vci_dls_total_vscale_r)
  }
  else if (vabs_total_age >= 2 & vabs_total_age <= 2.999) {
...
SocSSFunc0_1 <- function(vabs_total_age, vci_soc_total_vscale_r){
  score <- c()
  if (vabs_total_age >= 0 & vabs_total_age <1) { 
    if(vci_soc_total_vscale_r==2){score <-20}
    else if(vci_soc_total_vscale_r==3){score <-24}
    else if(vci_soc_total_vscale_r==4){score <-27}
    else if(vci_soc_total_vscale_r==5){score <-30}
    else if(vci_soc_total_vscale_r==6){score <-33}
    else if(vci_soc_total_vscale_r==7){score <-36}
    else if(vci_soc_total_vscale_r==8){score <-39}
    else if(vci_soc_total_vscale_r==9){score <-42}
    else if(vci_soc_total_vscale_r==10){score <-45}
    else if(vci_soc_total_vscale_r==11){score <-48}
    else if(vci_soc_total_vscale_r==12){score <-50}
    else if(vci_soc_total_vscale_r==13){score <-53}
    else if(vci_soc_total_vscale_r==14){score <-55}
    else if(vci_soc_total_vscale_r==15){score <-58}
    else if(vci_soc_total_vscale_r==16){score <-60}
    else if(vci_soc_total_vscale_r==17){score <-63}
    else if(vci_soc_total_vscale_r==18){score <-65}
    else if(vci_soc_total_vscale_r==19){score <-68}
    else if(vci_soc_total_vscale_r==20){score <-70}
    else if(vci_soc_total_vscale_r==21){score <-73}
    else if(vci_soc_total_vscale_r==22){score <-76}
    else if(vci_soc_total_vscale_r==23){score <-79}
    else if(vci_soc_total_vscale_r==24){score <-82}
    else if(vci_soc_total_vscale_r==25){score <-85}
    else if(vci_soc_total_vscale_r==26){score <-88}
    else if(vci_soc_total_vscale_r==27){score <-91}
    else if(vci_soc_total_vscale_r==28){score <-94}
    else if(vci_soc_total_vscale_r==29){score <-97}
    else if(vci_soc_total_vscale_r==30){score <-100}
    else if(vci_soc_total_vscale_r==31){score <-104}
    else if(vci_soc_total_vscale_r==32){score <-107}
    else if(vci_soc_total_vscale_r==33){score <-110}
    else if(vci_soc_total_vscale_r==34){score <-113}
    else if(vci_soc_total_vscale_r==35){score <-116}
    else if(vci_soc_total_vscale_r==36){score <-119}
    else if(vci_soc_total_vscale_r==37){score <-123}
    else if(vci_soc_total_vscale_r==38){score <-127}
    else if(vci_soc_total_vscale_r==39){score <-132}
    else if(vci_soc_total_vscale_r==40){score <-136}
    else if(vci_soc_total_vscale_r>=41 & vci_soc_total_vscale_r<=48){score <-140}
    else {score <- NA}
  }
  else {score <- NA}
  return(score)
...
SocSSFunc1_2 <- function(vabs_total_age, vci_soc_total_vscale_r){
  score <- c()
  if (vabs_total_age >= 1  & vabs_total_age <2) { 
    if(vci_soc_total_vscale_r==2){score <-20}
    else if(vci_soc_total_vscale_r==3){score <-23}
    else if(vci_soc_total_vscale_r==4){score <-26}
    else if(vci_soc_total_vscale_r==5){score <-29}
    else if(vci_soc_total_vscale_r==6){score <-32}
    else if(vci_soc_total_vscale_r==7){score <-35}
    else if(vci_soc_total_vscale_r==8){score <-38}
    else if(vci_soc_total_vscale_r==9){score <-41}
    else if(vci_soc_total_vscale_r==10){score <-45}
    else if(vci_soc_total_vscale_r==11){score <-48}
    else if(vci_soc_total_vscale_r==12){score <-52}
    else if(vci_soc_total_vscale_r==13){score <-55}
    else if(vci_soc_total_vscale_r==14){score <-58}
    else if(vci_soc_total_vscale_r==15){score <-61}
    else if(vci_soc_total_vscale_r==16){score <-64}
    else if(vci_soc_total_vscale_r==17){score <-67}
    else if(vci_soc_total_vscale_r==18){score <-70}
    else if(vci_soc_total_vscale_r==19){score <-72}
    else if(vci_soc_total_vscale_r==20){score <-75}
    else if(vci_soc_total_vscale_r==21){score <-77}
    else if(vci_soc_total_vscale_r==22){score <-80}
    else if(vci_soc_total_vscale_r==23){score <-82}
    else if(vci_soc_total_vscale_r==24){score <-85}
    else if(vci_soc_total_vscale_r==25){score <-88}
    else if(vci_soc_total_vscale_r==26){score <-91}
    else if(vci_soc_total_vscale_r==27){score <-94}
    else if(vci_soc_total_vscale_r==28){score <-97}
    else if(vci_soc_total_vscale_r==29){score <-100}
    else if(vci_soc_total_vscale_r==30){score <-103}
    else if(vci_soc_total_vscale_r==31){score <-105}
    else if(vci_soc_total_vscale_r==32){score <-108}
    else if(vci_soc_total_vscale_r==33){score <-110}
    else if(vci_soc_total_vscale_r==34){score <-113}
    else if(vci_soc_total_vscale_r==35){score <-115}
    else if(vci_soc_total_vscale_r==36){score <-117}
    else if(vci_soc_total_vscale_r==37){score <-119}
    else if(vci_soc_total_vscale_r==38){score <-121}
    else if(vci_soc_total_vscale_r==39){score <-123}
    else if(vci_soc_total_vscale_r==40){score <-125}
    else if(vci_soc_total_vscale_r==41){score <-127}
    else if(vci_soc_total_vscale_r==42){score <-129}
    else if(vci_soc_total_vscale_r==43){score <-132}
    else if(vci_soc_total_vscale_r==44){score <-135}
    else if(vci_soc_total_vscale_r==45){score <-137}
    else if(vci_soc_total_vscale_r>=46 & vci_soc_total_vscale_r<=48){score <-140}
    else {score <- NA}
  }
  else {score <- NA}
  return(score)
...
SocSSFuncTotal <- function(vabs_total_age, vci_soc_total_vscale_r){
  ...
  if(is.na(vabs_total_age) | vci_soc_total_vscale_r==0) {score <- NA}
    ...
    score <- SocSSFunc0_1(vabs_total_age, vci_soc_total_vscale_r)
  }
  else if (vabs_total_age >= 1 & vabs_total_age <2) {
    score <- SocSSFunc1_2(vabs_total_age, vci_soc_total_vscale_r)
  }
  else if (vabs_total_age >= 2 & vabs_total_age <= 2.999) {
...
ABCSSFunc1_2 <- function(vabs_total_age, vci_abc_sum_domain_ss_r){
  score <- c()
  if (vabs_total_age >= 1 & vabs_total_age <2) { 
    if(vci_abc_sum_domain_ss_r>=60 & vci_abc_sum_domain_ss_r<=61){score <-20}
    else if(vci_abc_sum_domain_ss_r>=62 & vci_abc_sum_domain_ss_r<=63){score <-21}
...
ABCSSFuncTotal <- function(vabs_total_age, vci_abc_sum_domain_ss_r){
  ...
  if(is.na(vabs_total_age) | is.na(vci_abc_sum_domain_ss_r)) {score <- NA}
    ...
    score <- ABCSSFunc0_1(vabs_total_age, vci_abc_sum_domain_ss_r)
  }
  else if (vabs_total_age >= 1 & vabs_total_age <2) {
    score <- ABCSSFunc1_2(vabs_total_age, vci_abc_sum_domain_ss_r)
  }
  else if (vabs_total_age >= 2 & vabs_total_age <= 2.999) {
...
MotSSFunc0_1 <- function(vabs_total_age, vci_motor_total_vscale_r){
  ...
  if (vabs_total_age >= 0 & vabs_total_age <1) { 
    ...
    else if(vci_motor_total_vscale_r==13){score <-49}
    else if(vci_motor_total_vscale_r==14){score <-52}
    else if(vci_motor_total_vscale_r==15){score <-55}
    else if(vci_motor_total_vscale_r==16){score <-58}
    else if(vci_motor_total_vscale_r==17){score <-61}
    else if(vci_motor_total_vscale_r==18){score <-64}
    else if(vci_motor_total_vscale_r==19){score <-67}
    else if(vci_motor_total_vscale_r==20){score <-70}
    else if(vci_motor_total_vscale_r==21){score <-73}
    else if(vci_motor_total_vscale_r==22){score <-76}
    else if(vci_motor_total_vscale_r==23){score <-79}
    else if(vci_motor_total_vscale_r==24){score <-83}
    else if(vci_motor_total_vscale_r==25){score <-86}
    else if(vci_motor_total_vscale_r==26){score <-89}
    else if(vci_motor_total_vscale_r==27){score <-91}
    ...
    else if(vci_motor_total_vscale_r==32){score <-107}
    else if(vci_motor_total_vscale_r==33){score <-110}
    else if(vci_motor_total_vscale_r==34){score <-113}
    else if(vci_motor_total_vscale_r==35){score <-116}
    else if(vci_motor_total_vscale_r==36){score <-119}
    else if(vci_motor_total_vscale_r==37){score <-122}
    else if(vci_motor_total_vscale_r==38){score <-125}
    else if(vci_motor_total_vscale_r==39){score <-128}
    else if(vci_motor_total_vscale_r==40){score <-131}
    else if(vci_motor_total_vscale_r==41){score <-134}
    else if(vci_motor_total_vscale_r==42){score <-137}
    else if(vci_motor_total_vscale_r>=43 & vci_motor_total_vscale_r<=48){score <-140}
    else {score <- NA}
  }
  else {score <- NA}
  return(score)
...
MotSSFunc1_2 <- function(vabs_total_age, vci_motor_total_vscale_r){
  score <- c()
  if (vabs_total_age >= 1 & vabs_total_age <2) { 
    if(vci_motor_total_vscale_r==2){score <-20}
    else if(vci_motor_total_vscale_r==3){score <-23}
    else if(vci_motor_total_vscale_r==4){score <-26}
    else if(vci_motor_total_vscale_r==5){score <-29}
    else if(vci_motor_total_vscale_r==6){score <-32}
    else if(vci_motor_total_vscale_r==7){score <-35}
    else if(vci_motor_total_vscale_r==8){score <-38}
    else if(vci_motor_total_vscale_r==9){score <-41}
    else if(vci_motor_total_vscale_r==10){score <-44}
    else if(vci_motor_total_vscale_r==11){score <-47}
    else if(vci_motor_total_vscale_r==13){score <-53}
    else if(vci_motor_total_vscale_r==14){score <-56}
    else if(vci_motor_total_vscale_r==15){score <-59}
    else if(vci_motor_total_vscale_r==16){score <-62}
    else if(vci_motor_total_vscale_r==17){score <-65}
    else if(vci_motor_total_vscale_r==18){score <-67}
    else if(vci_motor_total_vscale_r==19){score <-69}
    else if(vci_motor_total_vscale_r==20){score <-73}
    else if(vci_motor_total_vscale_r==21){score <-76}
    else if(vci_motor_total_vscale_r==22){score <-79}
    else if(vci_motor_total_vscale_r==23){score <-81}
    else if(vci_motor_total_vscale_r==24){score <-83}
    ...
    else if(vci_motor_total_vscale_r==28){score <-92}
    else if(vci_motor_total_vscale_r==29){score <-96}
    else if(vci_motor_total_vscale_r==30){score <-99}
    else if(vci_motor_total_vscale_r==31){score <-102}
    else if(vci_motor_total_vscale_r==32){score <-104}
    else if(vci_motor_total_vscale_r==33){score <-106}
    else if(vci_motor_total_vscale_r==34){score <-108}
    else if(vci_motor_total_vscale_r==35){score <-110}
    else if(vci_motor_total_vscale_r==36){score <-112}
    else if(vci_motor_total_vscale_r==37){score <-115}
    else if(vci_motor_total_vscale_r==38){score <-118}
    else if(vci_motor_total_vscale_r==39){score <-120}
    else if(vci_motor_total_vscale_r==40){score <-122}
    else if(vci_motor_total_vscale_r==41){score <-124}
    else if(vci_motor_total_vscale_r==42){score <-126}
    else if(vci_motor_total_vscale_r==43){score <-129}
    else if(vci_motor_total_vscale_r==44){score <-131}
    else if(vci_motor_total_vscale_r==45){score <-133}
    else if(vci_motor_total_vscale_r==46){score <-135}
...
MotSSFuncTotal <- function(vabs_total_age, vci_motor_total_vscale_r){
  ...
  if(is.na(vabs_total_age) | is.na(vci_motor_total_vscale_r)) {score <- NA}
    ...
    score <- MotSSFunc0_1(vabs_total_age, vci_motor_total_vscale_r)
  }
  else if (vabs_total_age >= 1 & vabs_total_age <2) {
    score <- MotSSFunc1_2(vabs_total_age, vci_motor_total_vscale_r)
  }
  else if (vabs_total_age >= 2 & vabs_total_age <= 2.999) {
